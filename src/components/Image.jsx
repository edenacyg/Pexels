...
function Image(props) {
	// console.log(props.imageWrapperId);
	...
	const handleDownload = () => {
		...
		if (window.location.pathname === '/profile') {
		  imageWrapperId = props.imageWrapperId;
		} else {
		  imageWrapperId = imageWrapper.getAttribute('id').replace('image_wrapper_', '');
		}
	...
	const handleDelete = () => {
		...
		if (index !== -1) {
			...
			if (arrayToDeleteFrom) {
			  const itemIndex = arrayToDeleteFrom.findIndex((image) => image.imageWrapperId === props.imageWrapperId); // use imageWrapperId to find index
